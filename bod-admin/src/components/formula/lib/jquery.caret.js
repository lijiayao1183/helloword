...
!(function (a, b) { typeof define === 'function' && define.amd ? define(['jquery'], function (c) { return a.returnExportsGlobal = b(c) }) : typeof exports === 'object' ? module.exports = b(require('jquery')) : b(jQuery) }(this, function (a) {
  'use strict'
  ...
  k = 'caret', b = (function () {
    ...
    return b.prototype.setPos = function (a) {
      ...
      return j.getSelection && (d = this.range()) ? (d.endOffset - 1 > 0 && d.endContainer !== this.domInputor && (b = d.cloneRange(), b.setStart(d.endContainer, d.endOffset - 1), b.setEnd(d.endContainer, d.endOffset), e = b.getBoundingClientRect(), c = {
        ...
        left: e.left + e.width,
        top: e.top
      }, b.detach()), c && (c != null ? c.height : void 0) !== 0 || (b = d.cloneRange(), f = a(h.createTextNode('|')), b.insertNode(f[0]), b.selectNode(f[0]), e = b.getBoundingClientRect(), c = {
        height: e.height,
        left: e.left,
        top: e.top
    ...
    return b.prototype.css_attr = ['borderBottomWidth', 'borderLeftWidth', 'borderRightWidth', 'borderTopStyle', 'borderRightStyle', 'borderBottomStyle', 'borderLeftStyle', 'borderTopWidth', 'boxSizing', 'fontFamily', 'fontSize', 'fontWeight', 'height', 'letterSpacing', 'lineHeight', 'marginBottom', 'marginLeft', 'marginRight', 'marginTop', 'outlineWidth', 'overflow', 'overflowX', 'overflowY', 'paddingBottom', 'paddingLeft', 'paddingRight', 'paddingTop', 'textAlign', 'textOverflow', 'textTransform', 'whiteSpace', 'wordBreak', 'wordWrap'], b.prototype.mirrorCss = function () {
      ...
      return b = {
        ...
        top: 0,
        zIndex: -2e4
      }, this.$inputor.prop('tagName') === 'TEXTAREA' && this.css_attr.push('width'), a.each(this.css_attr, function (a, d) { return b[d] = c.$inputor.css(d) }), b
  ...
  }()), e = {contentEditable: function (a) { return !(!a[0].contentEditable || a[0].contentEditable !== 'true') }}, g = {
    pos: function (a) { return a || a === 0 ? this.setPos(a) : this.getPos() },
    ...
    var b
    return (b = a != null ? a.iframe : void 0) ? (i = b, j = b.contentWindow, h = b.contentDocument || j.document) : (i = void 0, j = window, h = document)
  }, f = function (a) {
    var b
