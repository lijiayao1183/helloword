!(function (window) {
  function Element () {
    this.initialize = function () {
      ...
      if (a != null && b != null) this[a] = b
      else if (a != null) return this[a]
      return this
    }, this.save = function () {
      var a = this,
        b = {}
      ...
      return this.serializedProperties.forEach(function (d, e) {
        var f = a[d]
        typeof f === 'string' && (f = '"' + f + '"'), b += '"' + d + '":' + f, c > e + 1 && (b += ',')
      }), b += '}'
    }
  }
  CanvasRenderingContext2D.prototype.JTopoRoundRect = function (a, b, c, d, e) {
    typeof e === 'undefined' && (e = 5), this.beginPath(), this.moveTo(a + e, b), this.lineTo(a + c - e, b), this.quadraticCurveTo(a + c, b, a + c, b + e), this.lineTo(a + c, b + d - e), this.quadraticCurveTo(a + c, b + d, a + c - e, b + d), this.lineTo(a + e, b + d), this.quadraticCurveTo(a, b + d, a, b + d - e), this.lineTo(a, b + e), this.quadraticCurveTo(a, b, a + e, b), this.closePath()
...
(function (JTopo) {
  function MessageBus (a) {
    ...
    this.name = a, this.messageMap = {}, this.messageCount = 0, this.subscribe = function (a, c) {
      ...
      d == null && (b.messageMap[a] = []), b.messageMap[a].push(c), b.messageCount++
    }, this.unsubscribe = function (a) {
      var c = b.messageMap[a]
      c != null && (b.messageMap[a] = null, delete b.messageMap[a], b.messageCount--)
  ...
  function getDistance (a, b, c, d) {
    var e, f
    return c == null && d == null ? (e = b.x - a.x, f = b.y - a.y) : (e = c - a, f = d - b), Math.sqrt(e * e + f * f)
  }
  ...
  function getProperties (a, b) {
    for (var c = '', d = 0; d < b.length; d++) {
      d > 0 && (c += ',')
      var e = a[b[d]]
      typeof e === 'string' ? e = '"' + e + '"' : void 0 == e && (e = null), c += b[d] + ':' + e
    }
    return c
  }
  ...
  function changeColor (a, b, c, d, e) {
    ...
    for (var h = a.getImageData(0, 0, b.width, b.height), i = h.data, j = 0; f > j; j++) {
      for (var k = 0; g > k; k++) {
        var l = 4 * (j + k * f)
        i[l + 3] != 0 && (c != null && (i[l + 0] += c), d != null && (i[l + 1] += d), e != null && (i[l + 2] += e))
      }
    }
  ...
  function getOffsetPosition (a) {
    ...
    } else { do b += a.offsetTop || 0, c += a.offsetLeft || 0, a = a.offsetParent; while (a) }
    return {
      left: c,
      top: b
    }
  ...
  function intersectionLineBound (a, b) {
    ...
    return d == null && (c = JTopo.util.lineF(b.left, b.top, b.right, b.top), d = JTopo.util.intersection(a, c), d == null && (c = JTopo.util.lineF(b.right, b.top, b.right, b.bottom), d = JTopo.util.intersection(a, c), d == null && (c = JTopo.util.lineF(b.left, b.bottom, b.right, b.bottom), d = JTopo.util.intersection(a, c)))), d
  }
...
(function (a) {
    ...
    return {
      ...
      getImage: function (b, c) {
        var d = a.getBound(),
          e = 1,
          f = 1
        this.exportCanvas.width = a.canvas.width, this.exportCanvas.height = a.canvas.height, b != null && c != null ? (this.exportCanvas.width = b, this.exportCanvas.height = c, e = b / d.width, f = c / d.height) : (d.width > a.canvas.width && (this.exportCanvas.width = d.width), d.height > a.canvas.height && (this.exportCanvas.height = d.height))
  ...
  function c (c) {
    ...
    function f (a) {
      ...
      var b = d(a)
      n.dispatchEventToScenes('mouseout', b), n.dispatchEvent('mouseout', b), n.needRepaint = n.animate == 0 ? !1 : !0
    }
    ...
    function h (a) {
      var b = d(a)
      n.dispatchEventToScenes('mouseup', b), n.dispatchEvent('mouseup', b), n.mouseDown = !1, n.needRepaint = n.animate == 0 ? !1 : !0
    }
    ...
    function l (a) {
      var b = d(a)
      n.dispatchEventToScenes('mousewheel', b), n.dispatchEvent('mousewheel', b), n.wheelZoom != null && (a.preventDefault ? a.preventDefault() : (a = a || window.event, a.returnValue = !1), n.eagleEye.visible == 1 && n.eagleEye.update())
    }
    ...
    function m (b) {
      ...
      b.addEventListener('mouseup', h), b.addEventListener('mousemove', i), b.addEventListener('click', j), b.addEventListener('dblclick', k), a.util.isFirefox ? b.addEventListener('DOMMouseScroll', l) : b.addEventListener('mousewheel', l)), window.addEventListener && (
        window.addEventListener('keydown', function (b) {
          ...
          var c = b.keyCode;
          (c == 37 || c == 38 || c == 39 || c == 40) && (b.preventDefault ? console.log(b) : (b = b || window.event, b.returnValue = !1))
        }, !0),
    ...
    q.forEach(function (a) {
      ...
      this.canvas != null && (this.graphics.save(), this.graphics.clearRect(0, 0, this.width, this.height), this.childs.forEach(function (a) {
        a.visible == 1 && a.repaint(n.graphics)
      }), this.eagleEye.visible == 1 && this.eagleEye.paint(this), this.graphics.restore())
      ...
      return this.serializedProperties.forEach(function (a) {
        var d = b[a]
        typeof d === 'string' && (d = '"' + d + '"'), c += '"' + a + '":' + d + ','
      }), c += '"childs":[', this.childs.forEach(function (a) {
        c += a.toJson()
      }), c += ']', c += '}'
    },
    (function () {
      n.frames == 0 ? setTimeout(arguments.callee, 100) : n.frames < 0 ? (n.repaint(), setTimeout(arguments.callee, 1e3 / -n.frames)) : (n.repaint(), setTimeout(arguments.callee, 1e3 / n.frames))
    }()), setTimeout(function () {
...
(function (a) {
  function b (c) {
    ...
    this.initialize = function () {
    ...
    }, c != null && (c.add(this), this.addTo(c)), this.show = function () {
      this.visible = !0
    }, this.hide = function () {
      this.visible = !1
      ...
      for (var c = 0; c < this.zIndexArray.length; c++) {
        for (var d = this.zIndexArray[c], e = this.zIndexMap[d], f = 0; f < e.length; f++) {
          ...
          if (this.paintAll == 1 || this.isVisiable(g)) {
            ...
            g.shadow == 1 && (b.shadowBlur = g.shadowBlur, b.shadowColor = g.shadowColor, b.shadowOffsetX = g.shadowOffsetX, b.shadowOffsetY = g.shadowOffsetY), g instanceof a.InteractiveElement && (g.selected && g.showSelected == 1 && g.paintSelected(b), g.isMouseOver == 1 && g.paintMouseover(b)), g.paint(b), b.restore()
          }
        }
      }
      ...
      this.childs.push(a), this.zIndexMap[a.zIndex] == null && (this.zIndexMap[a.zIndex] = [], this.zIndexArray.push(a.zIndex), this.zIndexArray.sort(function (a, b) {
        return a - b
      ...
      return c.dx != null && (c.dx /= this.scaleX, c.dy /= this.scaleY), this.currentElement != null && (c.target = this.currentElement), c.scene = this, c
      ...
      if (this.mouseDown = !0, this.mouseDownX = c.x, this.mouseDownY = c.y, this.mouseDownEvent = c, this.mode == a.SceneMode.normal) this.selectElement(c), (this.currentElement == null || this.currentElement instanceof a.Link) && this.translate == 1 && (this.lastTranslateX = this.translateX, this.lastTranslateY = this.translateY)
      else {
        if (this.mode == a.SceneMode.drag && this.translate == 1) return this.lastTranslateX = this.translateX, void (this.lastTranslateY = this.translateY)
        this.mode == a.SceneMode.select ? this.selectElement(c) : this.mode == a.SceneMode.edit && (this.selectElement(c), (this.currentElement == null || this.currentElement instanceof a.Link) && this.translate == 1 && (this.lastTranslateX = this.translateX, this.lastTranslateY = this.translateY))
      }
      ...
      var c = this.toSceneEvent(b)
      this.currentElement != null && (c.target = e.currentElement, this.currentElement.mouseupHandler(c)), this.dispatchEvent('mouseup', c), this.mouseDown = !1
      ...
      var c = this.toSceneEvent(b)
      this.mode == a.SceneMode.normal ? this.currentElement == null || this.currentElement instanceof a.Link ? this.translate == 1 && (this.stage.cursor = a.MouseCursor.closed_hand, this.translateX = this.lastTranslateX + c.dx, this.translateY = this.lastTranslateY + c.dy) : this.dragElements(c) : this.mode == a.SceneMode.drag ? this.translate == 1 && (this.stage.cursor = a.MouseCursor.closed_hand, this.translateX = this.lastTranslateX + c.dx, this.translateY = this.lastTranslateY + c.dy) : this.mode == a.SceneMode.select ? this.currentElement != null ? this.currentElement.dragable == 1 && this.dragElements(c) : this.areaSelect == 1 && this.areaSelectHandle(c) : this.mode == a.SceneMode.edit && (this.currentElement == null || this.currentElement instanceof a.Link ? this.translate == 1 && (this.stage.cursor = a.MouseCursor.closed_hand, this.translateX = this.lastTranslateX + c.dx, this.translateY = this.lastTranslateY + c.dy) : this.dragElements(c)), this.dispatchEvent('mousedrag', c)
    ...
    return f.forEach(function (a) {
      ...
      a != null && a != 0 && (this.scaleX = a), b != null && b != 0 && (this.scaleY = b)
    }, this.zoomOut = function (a) {
      ...
      this.serializedProperties.forEach(function (c) {
        var d = a[c]
        c == 'background' && (d = a._background.src), typeof d === 'string' && (d = '"' + d + '"'), b += '"' + c + '":' + d + ','
      }), b += '"childs":['
...
(function (a) {
  ...
  function d () {
    ...
    this.paintCtrl = function (a) {
      ...
      if (this.selectedPoint = null, this.editAble == 1) {
...
(function (a) {
  function b (c) {
    this.initialize = function (c) {
      ...
      if (this.image) {
        var b = a.globalAlpha
        a.globalAlpha = this.alpha, this.image.alarm != null && this.alarm != null ? a.drawImage(this.image.alarm, -this.width / 2, -this.height / 2, this.width, this.height) : a.drawImage(this.image, -this.width / 2, -this.height / 2, this.width, this.height), a.globalAlpha = b
      ...
      if (this.borderWidth != 0) {
        ...
        this.borderRadius == null || this.borderRadius == 0 ? a.rect(-this.width / 2 - b, -this.height / 2 - b, this.width + this.borderWidth, this.height + this.borderWidth) : a.JTopoRoundRect(-this.width / 2 - b, -this.height / 2 - b, this.width + this.borderWidth, this.height + this.borderWidth, this.borderRadius), a.stroke(), a.closePath()
      }
      ...
      return a == null || a == 'Bottom_Center' ? d = {
        ...
        x: -this.width / 2 - b,
        y: c / 2
      }), this.textOffsetX != null && (d.x += this.textOffsetX), this.textOffsetY != null && (d.y += this.textOffsetY), d
    }, this.setImage = function (b, c) {
      if (b == null) throw new Error('Node.setImage(): 参数Image对象为空!')
      var d = this
      if (typeof b === 'string') {
        var e = j[b]
        e == null ? (e = new Image(), e.src = b, e.onload = function () {
          j[b] = e, c == 1 && d.setSize(e.width, e.height)
          var f = a.util.genImageAlarm(e)
          f && (e.alarm = f), d.image = e
        }) : (c && this.setSize(e.width, e.height), this.image = e)
      } else this.image = b, c == 1 && this.setSize(b.width, b.height)
  ...
  function e (a, b, c) {
    this.initialize(), this.text = a, this.href = b, this.target = c, this.elementType = 'LinkNode', this.isVisited = !1, this.visitedColor = null, this.paint = function (a) {
      ...
      this.target == '_blank' ? window.open(this.href) : location = this.href, this.isVisited = !0
    })
  }
...
(function (a) {
  ...
  function f (b, c, g) {
    ...
    this.initialize = function (b, c, d) {
      if (f.prototype.initialize.apply(this, arguments), this.elementType = 'link', this.zIndex = a.zIndex_Link, arguments.length != 0) {
        this.text = d, this.nodeA = b, this.nodeZ = c, this.nodeA && this.nodeA.outLinks == null && (this.nodeA.outLinks = []), this.nodeA && this.nodeA.inLinks == null && (this.nodeA.inLinks = []), this.nodeZ && this.nodeZ.inLinks == null && (this.nodeZ.inLinks = []), this.nodeZ && this.nodeZ.outLinks == null && (this.nodeZ.outLinks = []), this.nodeA != null && this.nodeA.outLinks.push(this), this.nodeZ != null && this.nodeZ.inLinks.push(this), this.caculateIndex(), this.font = '12px Consolas', this.fontColor = '255,255,255', this.lineWidth = 2, this.lineJoin = 'miter', this.transformAble = !1, this.bundleOffset = 20, this.bundleGap = 12, this.textOffsetX = 0, this.textOffsetY = 0, this.arrowsRadius = null, this.arrowsOffset = 0, this.dashedPattern = null, this.path = []
      ...
      var a
      return this.arrowsRadius != null && (a = h(this.nodeZ, this.nodeA)), a == null && (a = {
        x: this.nodeZ.cx,
        y: this.nodeZ.cy
      }), a
  ...
  function g (a, b, c) {
    this.initialize = function () {
      ...
      return this.direction == 'horizontal' ? this.nodeZ.cx > a.x ? a.x += this.nodeA.width / 2 : a.x -= this.nodeA.width / 2 : this.nodeZ.cy > a.y ? a.y += this.nodeA.height / 2 : a.y -= this.nodeA.height / 2, a
    }, this.getEndPosition = function () {
      var a = {
        x: this.nodeZ.cx,
        y: this.nodeZ.cy
      }
      return this.direction == 'horizontal' ? this.nodeA.cy < a.y ? a.y -= this.nodeZ.height / 2 : a.y += this.nodeZ.height / 2 : a.x = this.nodeA.cx < a.x ? this.nodeZ.x : this.nodeZ.x + this.nodeZ.width, a
  ...
  function h (a, b, c) {
    this.initialize = function () {
      ...
      return this.direction == 'horizontal' ? a.x = this.nodeZ.cx < a.x ? this.nodeA.x : this.nodeA.x + this.nodeA.width : a.y = this.nodeZ.cy < a.y ? this.nodeA.y : this.nodeA.y + this.nodeA.height, a
    }, this.getEndPosition = function () {
      var a = {
        x: this.nodeZ.cx,
        y: this.nodeZ.cy
      }
      return this.direction == 'horizontal' ? a.x = this.nodeA.cx < a.x ? this.nodeZ.x : this.nodeZ.x + this.nodeZ.width : a.y = this.nodeA.cy < a.y ? this.nodeZ.y : this.nodeZ.y + this.nodeZ.height, a
    }, this.getPath = function (a) {
  ...
  function b (c) {
    this.initialize = function (c) {
      ...
      if (this.borderWidth != 0) {
        a.beginPath(), a.lineWidth = this.borderWidth, a.strokeStyle = 'rgba(' + this.borderColor + ',' + this.alpha + ')'
        var b = this.borderWidth / 2
        this.borderRadius == null || this.borderRadius == 0 ? a.rect(this.x - b, this.y - b, this.width + this.borderWidth, this.height + this.borderWidth) : a.JTopoRoundRect(this.x - b, this.y - b, this.width + this.borderWidth, this.height + this.borderWidth, this.borderRadius), a.stroke(), a.closePath()
      }
    }, this.paintText = function (a) {
      var b = this.text
      if (b != null && b != '') {
...
(function (a) {
  ...
  function c (c, d) {
    ...
    c.forEach(function (a) {
      d.nodeDiameter == null ? (a.diameter && (h = a.diameter), h = a.radius ? 2 * a.radius : Math.sqrt(2 * a.width * a.height), n.push(h)) : n.push(h), l += h
  ...
  function j (a, b) {
    function c (b, e) {
      var f = q(a, b)
      d[e] == null && (d[e] = {}, d[e].nodes = [], d[e].childs = []), d[e].nodes.push(b), d[e].childs.push(f)
      ...
      function f (f, g) {
        for (var h = a.layout.getTreeDeep(f, g), k = j(f, g), l = k['' + h].nodes, m = 0; m < l.length; m++) {
          var n = l[m],
            o = (m + 1) * (c + 10),
            p = h * d
          b == 'down' || (b == 'up' ? p = -p : b == 'left' ? (o = -h * d, p = (m + 1) * (c + 10)) : b == 'right' && (o = h * d, p = (m + 1) * (c + 10))), n.setLocation(o, p)
        }
        for (var q = h - 1; q >= 0; q--) {
          for (var r = k['' + q].nodes, s = k['' + q].childs, m = 0; m < r.length; m++) {
            ...
            if (b == 'down' ? t.y = q * d : b == 'up' ? t.y = -q * d : b == 'left' ? t.x = -q * d : b == 'right' && (t.x = q * d), u.length > 0 ? b == 'down' || b == 'up' ? t.x = (u[0].x + u[u.length - 1].x) / 2 : (b == 'left' || b == 'right') && (t.y = (u[0].y + u[u.length - 1].y) / 2) : m > 0 && (b == 'down' || b == 'up' ? t.x = r[m - 1].x + r[m - 1].width + c : (b == 'left' || b == 'right') && (t.y = r[m - 1].y + r[m - 1].height + c)), m > 0) {
              ...
              } else if ((b == 'left' || b == 'right') && t.y < r[m - 1].y + r[m - 1].height) { for (var y = r[m - 1].y + r[m - 1].height + c, z = Math.abs(y - t.y), x = m; x < r.length; x++) i(e.childs, r[x], 0, z) }
            }
          }
        }
      }
      var g = null
      c == null && (g = h(e.childs), c = g.width, (b == 'left' || b == 'right') && (c = g.width + 10)), d == null && (g == null && (g = h(e.childs)), d = 2 * g.height), b == null && (b = 'down')
  ...
  function r (a, b, c) {
    ...
    if (p(b, d), c == 1) { for (var e = 0; e < d.length; e++) r(a, d[e], c) }
    return null
  }
...
(function (a) {
  function b () {
    ...
    return b.radius = 150, b.colors = ['#3666B0', '#2CA8E0', '#77D1F6'], b.datas = [0.3, 0.3, 0.4], b.titles = ['A', 'B', 'C'], b.paint = function (a) {
      var c = 2 * b.radius,
        d = 2 * b.radius
      ...
      for (var e = 0, f = 0; f < this.datas.length; f++) {
        ...
        j > Math.PI / 2 && j <= Math.PI ? k -= i : j > Math.PI && j < 2 * Math.PI * 3 / 4 ? k -= i : j > 2 * Math.PI * 0.75, a.fillStyle = '#FFFFFF', a.fillText(h, k, l), a.moveTo(this.radius * Math.cos(j), this.radius * Math.sin(j)), j > Math.PI / 2 && j < 2 * Math.PI * 3 / 4 && (k -= i), j > Math.PI, a.fill(), a.stroke(), a.closePath(), e += g
      }
    }, b
  }
  ...
  function c () {
    var b = new a.Node()
    return b.showSelected = !1, b.width = 250, b.height = 180, b.colors = ['#3666B0', '#2CA8E0', '#77D1F6'], b.datas = [0.3, 0.3, 0.4], b.titles = ['A', 'B', 'C'], b.paint = function (a) {
      var c = 3,
...
(function (a) {
  function b (b, c) {
    ...
    return {
      ...
      onStop: function (b) {
        return e == null && (e = new a.util.MessageBus()), e.subscribe('stop', b), this
      }
    }
  }
  ...
  function h (b, c) {
    function d (c, d, e, f, g) {
      ...
      return h.setImage(b.image), h.setSize(b.width, b.height), h.setLocation(c, d), h.showSelected = !1, h.dragable = !1, h.paint = function (a) {
        a.save(), a.arc(0, 0, e, f, g), a.clip(), a.beginPath(), this.image != null ? a.drawImage(this.image, -this.width / 2, -this.height / 2) : (a.fillStyle = 'rgba(' + this.style.fillStyle + ',' + this.alpha + ')', a.rect(-this.width / 2, -this.height / 2, this.width / 2, this.height / 2), a.fill()), a.closePath(), a.restore()
      }, h
    }
...
(function (a) {
    ...
    if (d != null) {
      ...
      if (d = b.match(/\s*(\w+)\s*\[\s*(\w+)\s*([>=<])\s*['"](\S+)['"]\s*\]\s*/), (d == null || d.length < 5) && (d = b.match(/\s*(\w+)\s*\[\s*(\w+)\s*([>=<])\s*(\d+(\.\d+)?)\s*\]\s*/), f = !0), d != null && d.length >= 5) {
        ...
        e = a.filter(function (a) {
          ...
          var b = a[h]
          return f == 1 && (b = parseInt(b)), i == '=' ? b == j : i == '>' ? b > j : i == '<' ? j > b : i == '<=' ? j >= b : i == '>=' ? b >= j : i == '!=' ? b != j : !1
        }), e != null && e.length > 0 && (c = c.concat(e))
      }
    }
    return c
  ...
  function c (a) {
    ...
    return a.attr = function (a, b) {
      if (a != null && b != null) { for (var c = 0; c < this.length; c++) this[c][a] = b } else {
        if (a != null && typeof a === 'string') {
          for (var d = [], c = 0; c < this.length; c++) d.push(this[c][a])
          return d
        }
        if (a != null) {
          for (var c = 0; c < this.length; c++) { for (var e in a) this[c][e] = a[e] }
        }
      }
      return this
    }, a
  ...
  function d (d) {
    ...
    var g = null
    return g = typeof d === 'function' ? f.filter(d) : b(f, d), g = c(g)
  }
...
(function (a) {
  ...
  c.prototype.forward = function (a) {
    ...
    return this._stack == null && (this._stack = []), this._stack.push([this.p, this.w]), this
